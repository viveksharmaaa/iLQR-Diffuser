...
sys.path.extend(['/home/sharma/Projects/DDAT/code/Quadcopter/datasets'])
...
modality = "SA" # whether diffusion predicts only states "S", states and actions "SA", or only actions "A"
env_name = "Quadcopter" # name of the environment in ["Hopper", "Walker", "HalfCheetah", "Quadcopter", "GO1", "GO2","Cartpole","Acrobot"]
proj_name = "iLQR" # name of the projector in [None, "Ref", "Adm", "SA", "A"]
