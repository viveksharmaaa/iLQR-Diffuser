...
if __name__ == "__main__":
    data = np.load("/home/sharma/Projects/DDAT/code/Quadcopter/datasets/Quadcopter_4trajs_200steps.npz")
    # plt.plot(data['Trajs'][0])
    ...
    X_target = 0.001* bb.rollout_from(x0, U_zero)  + np.random.randn(T+1, bb.n)
    #X_target = data['Trajs'][0][:,:4]
    ...
    plt.plot(X_target[:, 0], X_target[:, 1],'--')
    plt.show()
